...
//ytt clear ecc flag
/* ytt add: clear RAMECC flags inline after RAM scrub, before .data/.bss init
 * 不新增 section，不呼叫 sub-function，不 push/pop stack。
 */
  movs r0, #0x07

  ldr  r1, =0x52009024      /* RAMECC1_M1SR */
  str  r0, [r1]

  ldr  r1, =0x52009044      /* RAMECC1_M2SR */
  str  r0, [r1]

  ldr  r1, =0x52009064      /* RAMECC1_M3SR */
  str  r0, [r1]

  ldr  r1, =0x52009084      /* RAMECC1_M4SR */
  str  r0, [r1]

  ldr  r1, =0x520090A4      /* RAMECC1_M5SR */
  str  r0, [r1]
